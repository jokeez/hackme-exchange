...
| # | Gate | How | Status |
|---|------|-----|--------|
| G1 | Unit / UI suite | `npm test` | ✅ **812** (2026-09-14; live lab opt-in) |
...
| G10 | Visual pass | `npm run test:e2e` (`g10_visual_pass.mjs`) | ✅ **P0=0 P1=0** (2026-09-14) |
...
| G14 | Full UI/UX | `npm run test:e2e` (G10) · `npm run test:e2e:full` (mega) | ✅ P0=0 P1=0 (2026-09-14) |
