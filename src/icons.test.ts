...
describe("icons", () => {
  ...
  it("assetBadge: known coins use logo images", () => {
    expect(assetBadge("HMC")).toContain("/logo-hex.png?v=4");
    expect(assetBadge("HMC")).toContain("asset-hmc");
    expect(assetBadge("SUP")).toContain("/assets/coins/sup.svg?v=4");
    expect(assetBadge("SUP")).toContain("asset-coin-logo");
    expect(assetBadge("USDT")).toContain("/assets/coins/usdt.png?v=4");
    expect(assetBadge("BTC")).toContain("/assets/coins/btc.png?v=4");
  ...
  it("pairAssetIcons shows base only (no quote stack)", () => {
    ...
    expect(html).toContain("/logo-hex.png?v=4");
